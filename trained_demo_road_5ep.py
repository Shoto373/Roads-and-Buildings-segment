...
model = torch.load('weights/road_model_5_epochs.pth', map_location=DEVICE, weights_only=False)
model.eval()
...
plt.subplot(1, 3, 3)
plt.title("Prediction Road (Trained 5 Epochs)")
plt.axis('off')
plt.imshow(pred_colored)

plt.savefig('outputs/trained_demo_road_5ep_output.png')
print("Saved outputs/trained_demo_road_5ep_output.png")
